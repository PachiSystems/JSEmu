...
//<editor-fold desc="BNE Tests">

QUnit.module("Instruction - BNE", {
    setup: function() {
        MOS6502.init();
    }
});

test("0xD0 - BNE (Relative)", function() {
    /**
     *    Instruction = BNE - Branch on result not zero
     * Affected Flags = None
     *    Total Tests = 5
     */
    ...
    /**
     * Test 1: Zero set (no branch, but 2 cycles used)
     */
    ...
    equal(MOS6502._PC,
            PCStart + BytesUsed,
        "Zero set: Program Counter set correctly.");

    equal(MOS6502._CYCLES,
        CycleCost,
        "Zero set: Cycles set correctly.");
    ...
    equal(MOS6502._PC,
            PCStart + relativePlusSamePage,
        "Zero clear, branch forward, same page: Program Counter set correctly.");

    equal(MOS6502._CYCLES,
            CycleCost + 1,
        "Zero clear, branch forward, same page: Cycles set correctly.");
    ...
    equal(MOS6502._CYCLES,
            CycleCost + 1,
        "Zero clear, branch backwards, same page: Cycles set correctly.");

    /**
     * Test 4: Zero clear. Branch forward to different page. (4 cycles)
     *
     * NOTE: It's not possible to branch to another page from 0x4080. Using 0x40E0 for forward branch.
     */
    ...
    equal(MOS6502._PC,
            PCStartHigh + relativePlusNextPage,
        "Zero clear, branch forward, different page: Program Counter set correctly.");

    equal(MOS6502._CYCLES,
            CycleCost + 2,
        "Zero clear, branch forward, different page: Cycles set correctly.");
    ...
    equal(MOS6502._CYCLES,
            CycleCost + 2,
        "Zero clear, branch backwards, different page: Cycles set correctly.");
...
test("0xE0 - CPX (Immediate)",function() {
    /**
     *    Instruction = CPX - Compare Memory and Index X.
     * Affected Flags = Sign, Zero, Carry
     *    Total Tests = 3
     */
    var OPCODE = 0xE0,
...
test("0xE4 - CPX (Zero Page)",function() {
    /**
     *    Instruction = CPX - Compare memory and index X.
     * Affected Flags = Sign, Zero, Carry
     *    Total Tests = 3
...
test("0xEC - CPX (Absolute)",function() {
    /**
     *    Instruction = CPX - Compare memory and index X.
     * Affected Flags = Sign, Zero, Carry
     *    Total Tests = 3
...
//<editor-fold desc="BEQ Tests">

QUnit.module("Instruction - BEQ", {
    setup: function() {
        MOS6502.init();
    }
});

test("0xF0 - BEQ (Relative)", function() {
    /**
     *    Instruction = BEQ - Branch on result zero
     * Affected Flags = None
     *    Total Tests = 5
     */
    ...
    /**
     * Test 1: Zero not set (no branch, but 2 cycles used)
     */
    ...
    equal(MOS6502._PC,
            PCStart + relativePlusSamePage,
        "Zero set, branch forward, same page: Program Counter set correctly.");

    equal(MOS6502._CYCLES,
            CycleCost + 1,
        "Zero set, branch forward, same page: Cycles set correctly.");
    ...
    equal(MOS6502._CYCLES,
            CycleCost + 1,
        "Zero set, branch backwards, same page: Cycles set correctly.");

    /**
     * Test 4: Zero set. Branch forward to different page. (4 cycles)
     *
     * NOTE: It's not possible to branch to another page from 0x4080. Using 0x40E0 for forward branch.
     */
    ...
    equal(MOS6502._PC,
            PCStartHigh + relativePlusNextPage,
        "Zero set, branch forward, different page: Program Counter set correctly.");

    equal(MOS6502._CYCLES,
            CycleCost + 2,
        "Zero set, branch forward, different page: Cycles set correctly.");
    ...
    equal(MOS6502._CYCLES,
            CycleCost + 2,
        "Zero set, branch backwards, different page: Cycles set correctly.");
